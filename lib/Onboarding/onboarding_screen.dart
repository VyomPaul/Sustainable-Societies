...
import 'package:untitled/Onboarding/slide_screen.dart';
...
class _BoardingScreenState extends State<BoardingPage> {
  ...
  void initState() {
    _currentPage = 0;
    _slides = [
      Slide("https://image.freepik.com/free-vector/save-planet-concept-with-people-taking-care-earth_23-2148522570.jpg", "Find Sustainable Societies in India"),
      Slide(
          "x", "You can add your society here"),
      Slide("lib/resources/slide-3.png",
          "Societies using renewable energy sources"),
      Slide("","Use processes like composting, rainwater harvesting etc."),
    ];
      ...
      children: <Widget>[
        Expanded(
          ...
          child: Container(
            ...
            child: Image.network(slide.image, fit: BoxFit.contain),
          ),
        ),
        Padding(
